...
export const projectsData = [
  {
    imgPath:
      "https://user-images.githubusercontent.com/99739515/191304833-6e9b8956-d9e2-4b84-8e01-f0928194b0b4.gif",
    isBlog: false,
    title: "ThreeJs-React WeatherApp",
    description:
      "In this project I have build a weather app by using ThreeJs and React.Get information with api and display it in a list. Also, I have used Material Ui, SASS for styling and also react-router-dom for routing. You can visit all around of earth and check weather wherever you want. As state management, i have used contextApi. 3rd part libraries such as axios toastify autoanimation",
    ghLink: "https://github.com/yaserdemet/react-threeJs",
    demoLink: "https://react-weather-app-sigma-silk.vercel.app",
  },
  {
    imgPath:
      "https://user-images.githubusercontent.com/99739515/189138222-195e59d7-a3ce-4ddc-ba6a-d8a1396bcbd9.gif",
    isBlog: false,
    title: "NextJs Ricky and Morty",
    description:
      "This project was built with nextJs. In this project i have used nextAuth to login, Next-i18next library for translation, NextRouter for multi dynamc page application, Material Ui and module.css for styling, server side rendering, Layout and reuseable components",
    ghLink: "https://github.com/yaserdemet/nextjs_rick_morty",
    demoLink: "https://github.com/yaserdemet/nextjs_rick_morty",
  },
  {
    imgPath:
      "https://user-images.githubusercontent.com/99739515/186932343-eaeeb885-ef78-4577-ae5e-24777bcb0a04.gif",
    isBlog: false,
    title: "React Getir",
    description:
      "This project aims to clone famous Getir clone with React. Following topics have been covered; props and state logic, conditional rendering, React hooks, 3rd party libraries such as axios, toastify, reactFlags. For styling Material UI and Bootstrap was used. For Seo optimization Helmet Hook was used",
  ...
  },
  {
    ...
    description:
      "This project was created with React.js and React-Router-DOM. Nested routes are used to navigate between pages. Used hooks such as useState useEffect useParams and useNavigate. Information and avatars comes from api by axios and is displayed in a list. Third part library which is Toastify is used for notification",
  ...
  },
  {
    ...
    description:
      "I have made similiar todo project with pure Js. But with react it is more easy to use. Practiced many of react features such as conditional rendering, prop and component logic, js iteration methods, and react hooks such as useState useEffect.",
  ...
  },
  {
    ...
    description:
      "This project demonstrates the use of styled-components in React applications. Component-based styling, theme management, and responsive design patterns are implemented.",
  ...
  },
  {
    ...
    description:
      "This is my first React project. In this project i used iteration method to get data from static JSON format and display it in a list. Get data in main component and iterate it in child component. Used props, components, conditional rendering and state to display data in a list. Last of all used css styling to make the project look aluring.",
    ghLink: "https://github.com/yaserdemet/Styled-Component-React",
    demoLink: "https://github.com/yaserdemet/Styled-Component-React",
  },
  {
    ...
    description:
      "To do list is created with pure javascript and Dom manipulation. When user want to add some task to the list, user can type the task and press enter. When user want to delete a task, user can click on the task and press delete button. Sound effect is played when user add a task. Conditional icons are used to show the status of the task.",
  ...
  },
  {
    ...
    description:
      "This project's static part was created Html and Css grid system. The dynamic part was created with Vanilla JS. The calculator was created with the help of the 'mathjs' library. Dom manipulation and its method which is capturing was used to display the result of the calculation.",
    ghLink: "https://github.com/yaserdemet/stone-paper-js",
    demoLink: "https://yaserdemet.github.io/stone-paper-js/",
  },
  {
  ...
  },
  {
    ...
    description:
      "Bootstrap Carousel is a responsive image carousel. It is a great way to showcase your work portfolio or just some images. Many features of Bootstrap was used in this project cards, buttons, navbar, carausel and grid system.",
  ...
  },
  {
    ...
    description:
      "In this project i used SASS to style the portfolio page. The project is responsive and works on all devices. Break into many folders to make it easier to manage files and read them easily. Sass's many features are used such as mixins, variables, nested rules, media queries, and more.",
    ghLink: "https://github.com/yaserdemet/guess-number-js",
    demoLink: "https://yaserdemet.github.io/guess-number-js/",
  },
  {
    ...
    description:
      "In this project i used bootstrap' colors, cards, container, row structure and grid system to make fully responsive for all device. form elements.",
  ...
  },
  {
    ...
    title: "Parallax Page",
    description:
      "To make parallax page gave background img to container. Then background-attachment:fixed; background-position:center; background-repeat:no-repeat; background-size:cover;",
    ghLink: "https://github.com/yaserdemet/boostrap2-project",
  ...
  },
  {
    ...
    description:
      "This page clone the Netflix login page. The page is fully responsive and works on all devices. The page is built with HTML, CSS.",
  ...
  },
  {
    ...
    description:
      "This is a landing page for Google. It is a simple landing page with a search bar and a sign in button. The user can search for a website and sign in to Google.",
